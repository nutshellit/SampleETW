...
namespace EventSourceSamples
{
    ...
    public sealed class EventLogEventSource : EventSource
    {
        ...
        [Event(1, Keywords = Keywords.Requests, Message = "Start processing request {0} for URL {1}",
        ...
        [Event(3, Keywords = Keywords.Requests, Message = "Start processing request for URL",
    ...
    static class RegisterEventSourceWithOperatingSystem
    {
        ...
        public static void SimulateInstall(string destFolder, string eventSourceName= "", bool prompt = true)
        {
            ...
            Out.WriteLine("These steps are only need for Windows Event Log support.");
            ...
            foreach (var filename in Directory.EnumerateFiles(sourceFolder, "*" + eventSourceName + "*.etwManifest.???"))
            {
            ...
            foreach (var filename in Directory.EnumerateFiles(destFolder, "*.etwManifest.man"))
            {
